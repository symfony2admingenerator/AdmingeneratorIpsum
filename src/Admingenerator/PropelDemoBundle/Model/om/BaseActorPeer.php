...
use Admingenerator\PropelDemoBundle\Model\map\ActorTableMap;

/**
 * Base static class for performing query and update operations on the 'propel_actors' table.
 *
 * 
 *
...
abstract class BaseActorPeer {
	...
	const TABLE_NAME = 'propel_actors';

	/** the related Propel class for this table */
	const OM_CLASS = 'Admingenerator\\PropelDemoBundle\\Model\\Actor';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'host/admingen/src/Admingenerator/PropelDemoBundle/Model.Actor';
	...
	const ID = 'propel_actors.ID';

	/** the column name for the NAME field */
	const NAME = 'propel_actors.NAME';
	...
	/**
	 * Method to invalidate the instance pool of all tables related to propel_actors
	...
	public static function doCountJoinActorHasMovieRelatedById(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ActorPeer::ID, ActorHasMoviePeer::ACTOR_ID, $join_behavior);
	...
	/**
	 * Selects a collection of Actor objects pre-filled with their ActorHasMovie objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinActorHasMovieRelatedById(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Actor) to $obj2 (ActorHasMovie)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Actor) to the collection in $obj2 (ActorHasMovie)
				$obj1->setActorHasMovie($obj2);
	...
	/**
	 * Performs an UPDATE on the database, given a Actor or Criteria object.
	 *
	...
	/**
	 * Deletes all rows from the propel_actors table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
